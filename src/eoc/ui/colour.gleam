...
pub fn decoder(json: Dynamic) -> Result(ColourScale, List(DecodeError)) {
  decode.run(json, colour_scale_decoder())
}

pub fn colour_scale_decoder() -> decode.Decoder(ColourScale) {
  let color_decoder = colour.decoder()
  use bg <- decode.field("bg", color_decoder)
  use bg_subtle <- decode.field("bg_subtle", color_decoder)
  use tint <- decode.field("tint", color_decoder)
  use tint_subtle <- decode.field("tint_subtle", color_decoder)
  use tint_strong <- decode.field("tint_strong", color_decoder)
  use accent <- decode.field("accent", color_decoder)
  use accent_subtle <- decode.field("accent_subtle", color_decoder)
  use accent_strong <- decode.field("accent_strong", color_decoder)
  use solid <- decode.field("solid", color_decoder)
  use solid_subtle <- decode.field("solid_subtle", color_decoder)
  use solid_strong <- decode.field("solid_strong", color_decoder)
  use solid_text <- decode.field("solid_text", color_decoder)
  use text <- decode.field("text", color_decoder)
  use text_subtle <- decode.field("text_subtle", color_decoder)
...
pub fn palette_decoder() -> decode.Decoder(ColourPalette) {
  let d = colour_scale_decoder()

  use base <- decode.field("base", d)
  use primary <- decode.field("primary", d)
  use secondary <- decode.field("secondary", d)
  use success <- decode.field("success", d)
  use warning <- decode.field("warning", d)
  use danger <- decode.field("danger", d)
