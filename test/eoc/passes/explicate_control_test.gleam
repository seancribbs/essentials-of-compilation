...
// import eoc/langs/l_tup.{Eq, Lt} as l
...
//           ),
//         ),
//         #("block_2", c.Seq(c.Assign("_8", c.Atom(c.Void)), c.Goto("block_1"))),
//         #("block_3", c.Seq(c.Collect(16), c.Goto("block_1"))),
//         #(
//           "block_4",
//           c.Seq(
...
//           ),
//         ),
//         #("block_5", c.Seq(c.Assign("_4", c.Atom(c.Void)), c.Goto("block_4"))),
//         #("block_6", c.Seq(c.Collect(16), c.Goto("block_4"))),
//         #(
//           "start",
//           c.Seq(
...
//                   c.If(
//                     c.Prim(c.Cmp(Lt, c.Variable("tmp.2"), c.Variable("tmp.3"))),
//                     c.Goto("block_5"),
//                     c.Goto("block_6"),
//                   ),
//                 ),
