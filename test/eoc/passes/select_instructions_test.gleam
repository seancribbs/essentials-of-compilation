...
//   assert select_instructions.compute_tag(1, l.VectorT([l.VectorT([l.IntegerT])])) == 0b10000010

//   assert select_instructions.compute_tag(1, l.VectorT([l.IntegerT])) == 0b00000010
